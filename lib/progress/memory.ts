...
import { BASE_TITLE, REWARD_VERSION } from "../gamification";
const blank=(userId:string,displayName:string):PlayerProgress=>{const input:ProgressWrite={currentGold:0,totalGold:0,xp:0,rewardVersion:REWARD_VERSION,visualCorrect:0,selectedTitle:BASE_TITLE,defeated:{},collection:{},attempts:{},perfectBosses:{},visualPerfectEras:{}};return {userId,displayName,...input,...derived(input),updatedAt:0}};
