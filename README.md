...
최태성 한국사 필기를 바탕으로 1~30강의 연습 전투, 3단계 보스전, 도감, 계정별 순위표와 별도 `/era-visual-quiz` 시대별 그림 퀴즈를 제공하는 Next.js 앱입니다. 배포 대상은 Vercel이며 영구 데이터는 Firebase Cloud Firestore에 저장합니다.
